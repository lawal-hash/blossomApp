...
def get_users_args():
    ...
    parser.add_argument('--arch', type=str, default='Efficientnet',
                        help='Type of pre-trained neural network architecture to use, other supported architectures include MNASNet, Swin_T,maxvit_t,ConvNeXt, and RegNet')
    ...
    parser.add_argument('--learning_rate', type=float,
                        default=0.0001, help='path to folder of images')
    ...
    parser.add_argument('--trainable', type=bool, default=False,
                        help='Freeze the earlier parameter of the pretrain model when True')
